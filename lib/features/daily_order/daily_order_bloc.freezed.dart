...
class _$OrderActionTearOff {
  const _$OrderActionTearOff();

  _InitialData initialData() {
    return _InitialData();
  }

  _SubmitOrder submitOrder(Order order) {
    return _SubmitOrder(
      order,
    );
  }

  _UpdateOrder updateOrder(Order order) {
    return _UpdateOrder(
      order,
    );
  }
...
const $OrderAction = _$OrderActionTearOff();

mixin _$OrderAction {
  @optionalTypeArgs
  Result when<Result extends Object>({
    @required Result initialData(),
    @required Result submitOrder(Order order),
    @required Result updateOrder(Order order),
  });
  @optionalTypeArgs
...
abstract class $OrderActionCopyWith<$Res> {
  factory $OrderActionCopyWith(
      ...
      _$OrderActionCopyWithImpl<$Res>;
}

class _$OrderActionCopyWithImpl<$Res> implements $OrderActionCopyWith<$Res> {
  _$OrderActionCopyWithImpl(this._value, this._then);

  final OrderAction _value;
  // ignore: unused_field
  final $Res Function(OrderAction) _then;
}
...
class __$InitialDataCopyWithImpl<$Res> extends _$OrderActionCopyWithImpl<$Res>
...
class _$_InitialData implements _InitialData {
  ...
  @override
  String toString() {
    return 'OrderAction.initialData()';
  }
...
abstract class _InitialData implements OrderAction {
...
class __$SubmitOrderCopyWithImpl<$Res> extends _$OrderActionCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_SubmitOrder(
      order == freezed ? _value.order : order as Order,
    ));
  }
...
class _$_SubmitOrder implements _SubmitOrder {
  ...
  @override
  String toString() {
    return 'OrderAction.submitOrder(order: $order)';
  }
...
abstract class _SubmitOrder implements OrderAction {
  factory _SubmitOrder(Order order) = _$_SubmitOrder;
...
class __$UpdateOrderCopyWithImpl<$Res> extends _$OrderActionCopyWithImpl<$Res>
...
class _$_UpdateOrder implements _UpdateOrder {
  ...
  @override
  String toString() {
    return 'OrderAction.updateOrder(order: $order)';
  }
...
abstract class _UpdateOrder implements OrderAction {
  factory _UpdateOrder(Order order) = _$_UpdateOrder;
...
class __$LoadedCopyWithImpl<$Res> extends _$OrderStateCopyWithImpl<$Res>
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'OrderState.loaded(store: $store)';
  }
...
class __$SubmittedCopyWithImpl<$Res> extends _$OrderStateCopyWithImpl<$Res>
...
abstract class _Submitted implements OrderState {
...
class __$UpdatedCopyWithImpl<$Res> extends _$OrderStateCopyWithImpl<$Res>
...
abstract class _Updated implements OrderState {
...
class __$ErrorCopyWithImpl<$Res> extends _$OrderStateCopyWithImpl<$Res>
